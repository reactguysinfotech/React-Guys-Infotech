      ...
      <Wrapper>
        ...
        <Div className="mb-10 relative">
          ...
          <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center max-w-[1000px] mx-auto">
            Feel free to reach out to us using the contact form below. Be sure
            to provide detailed information about your project, including your
            industry and any specific requirements you may have.
          </div>
        </Div>
        {/* SECTION HEADING END */}
