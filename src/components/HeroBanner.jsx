...
import dev from "../assets/henishPhoto.jpg";
  ...
  return (
    ...
    >
      ...
      <Wrapper>
        ...
        >
          <div className="flex items-center gap-[6px]">
            ...
            <div style={{ fontSize: "20px" }}>
              <a
                href="mailto:reactguys.infotech@gmail.com"
                style={{ color: "white", textDecoration: "underline" }}
                onMouseOver={{ color: "black" }}
                onMouseOut={{ color: "white" }}
              >
                reactguys.infotech@gmail.com
              </a>
            </div>
          </div>
        ...
        {/* BIG HEADING START */}
        <motion.div
          className="flex justify-center text-center mt-14 mb-5 relative"
        ...
        >
          ...
          {/* <img
            src={dev}
            style={{ borderRadius: "150px", height: "220px", margin: "20px" }}
          /> */}
        </motion.div>
        {/* BIG HEADING END */}
        ...
        <div className="flex flex-wrap gap-5">
          ...
          >
            <div className="font-light mb-4">
              👋 Hi, We are <span className="font-semibold">React Guys 🙋‍♂️</span>
            </div>
            <div className="max-w-[510px]">
              With our expertise in creating and maintaining modern websites and
              applications, we are dedicated to delivering innovative solutions
              that address all your business problems.
            </div>
          </motion.div>
          {/* INTRO END */}
          ...
          >
            ...
            {/* START */}
            <div className="flex items-center gap-3">
              <div className="text-[80px] font-light">2.5+</div>
              <div className="leading-[22px]">
                YEARS OF
                <br />
                EXPERIENCE
